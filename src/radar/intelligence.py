...
def _build_final_brief_prompt(
    ...
    return (
        ...
        "用朴素中文和大白话，避免营销语言。不要分析源码架构、不要提供安装教程、不要声称组织使用过该项目。\n"
        "one_liner 不超过 40 个汉字；what_it_does 和 why_it_matters_to_user 都只能写 1 至 2 句、各不超过 80 个汉字，"
        "直接回答“它做什么”和“这对这位用户有什么用”，不要列举功能清单或重复解释。\n"
